...
type
  ...
  private
    ...
    vUtilizaCadTeclas,
    vUtilizaCadCheckList,
    vUtilizaCadRecados  : Boolean ;
...
Uses
  MenuPrincipal, Bgm_Tela, CTR_CadastroDeCheckList, CTR_CadastroDeAtalhos, CTR_RemitirRelatorio ;
...
begin
  ...
  vUtilizaCadTeclas    := True ;
  vUtilizaCadCheckList := True ;
  vUtilizaCadRecados   := True ;
end;
...
begin
  ...
  begin
    ...
    vCodIntFunc          := FieldByName('CODINTFUNC').AsInteger;
    vUtilizaCadTeclas    := FieldByName('UTILIZACADTECLAS'   ).AsString = 'S' ;
    vUtilizaCadCheckList := FieldByName('UTILIZACADCHECKLIST').AsString = 'S' ;
    vUtilizaCadRecados   := FieldByName('UTILIZACADRECADOS'  ).AsString = 'S' ;
...
begin
  FMenuItem[0].Visible := vUtilizaCadTeclas ;
  FMenuItem[1].Visible := vUtilizaCadCheckList ;
  FMenuItem[2].Visible := vUtilizaCadRecados ;
