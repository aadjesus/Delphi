...
begin
  ...
  cAboutVersao         := '2.1.0' ;
  cAboutAutor          := 'Alessando A.J - 01/01/2005' ;
end;
...
begin
  ...
  FMDataDispo             := TRxMemoryData.Create(Self) ;
  FMDataDispo.Name        := 'FMDataDispo' ;
  FDSourceDispo           := TDataSource.Create(Self) ;
  ...
  FMDataAssoc             := TRxMemoryData.Create(Self) ;
  FMDataAssoc.Name        := 'FMDataAssoc' ;
  FDSourceAssoc           := TDataSource.Create(Self) ;
