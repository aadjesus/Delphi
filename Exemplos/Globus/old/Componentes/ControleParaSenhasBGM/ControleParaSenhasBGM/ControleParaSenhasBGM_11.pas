...
Uses
  MenuPrincipal, Bgm_Tela, CTR_CadastroDeCheckList, CTR_CadastroDeAtalhos ;
...
Var
  i : Integer ;
const
  vMenuItemCaption : Array[0..3] of String = ('Cadastro de atalhos','Check-List'     ,'Cadastro de recados','Novidades do módulo') ;
  vMenuItemName    : Array[0..3] of String = ('FIMenuTeclas'       ,'FIMenuCheckList','FIMenuRecados'      ,'FIMenuNovidades'    ) ;
begin
...
begin
  FMenuItem[0].Visible := vcUtilizaCadTeclas ;
  FMenuItem[1].Visible := vcUtilizaCadCheckList ;
  FMenuItem[2].Visible := vcUtilizaCadRecados ;
...
begin
  ...
  Case TMenuItem(Sender).MenuIndex of
    ...
    3 : Begin
          MensagemDlg('Em desenvolvimento', mtInformacao, mbOk );
        End ; // 3 : Begin
  End ; // Case TMenuItem(Sender).MenuIndex of
end;
