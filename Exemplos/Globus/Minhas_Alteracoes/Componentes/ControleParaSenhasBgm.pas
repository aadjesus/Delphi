...
begin
  ...
  If (vcUsuario <> 'GLOBUS') and (vcSistema <> 'GRP') and TabelaExiste('CTR_Novidades'{'CTR_NovidadesDosModulos'}) Then
    With TFrmCTR_NovidadesDoModulo.Create(Self) Do
    Begin
      If RMDNovidades.Locate('LIDA',0,[loCaseInsensitive]) Then
      Begin
        IMenuLerClick(IMenuLer) ;
        ShowModal ;
      End ; // If RMDNovidades.Locate(...  
      Free ;
    End; // With TFrmCTR_NovidadesDoModulo.Create(Self) Do
